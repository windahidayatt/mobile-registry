...
class DeleteIntraOperativeUseCase extends UseCase<bool, String> {
  final OperativeRepository _repository;
  DeleteIntraOperativeUseCase(this._repository);

  @override
  Future<Either<Failure, bool>> call(String params) {
    return _repository.deleteIntraOperative(params);
  }
}
